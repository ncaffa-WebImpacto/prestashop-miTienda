<?php
/* Smarty version 3.1.33, created on 2020-05-13 18:17:34
  from 'C:\xampp\htdocs\mitienda\themes\PRS028\templates\checkout\_partials\steps\payment.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ebc1d9e19e5d3_10783631',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f4268b3cacc9e4c38b90a6f84a82ab2948d28e12' => 
    array (
      0 => 'C:\\xampp\\htdocs\\mitienda\\themes\\PRS028\\templates\\checkout\\_partials\\steps\\payment.tpl',
      1 => 1589356898,
      2 => 'file',
    ),
  ),
...
function content_5ebc1d9e19e5d3_10783631 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_9966649105ebc1d9e160e62_41741310', 'step_content');
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, 'checkout/_partials/steps/checkout-step.tpl');
}
/* {block 'step_content'} */
class Block_9966649105ebc1d9e160e62_41741310 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'step_content' => 
  array (
    0 => 'Block_9966649105ebc1d9e160e62_41741310',
  ),
);
...
?>
    ...
    <?php }?>
    <div class="payment-options <?php if ($_smarty_tpl->tpl_vars['is_free']->value) {?>d--none<?php }?>">
        <?php
...
-container" class="payment-option clearfix">
                            ...
                            <input
                                    class="ps-shown-by-js custom-control-input<?php if ($_smarty_tpl->tpl_vars['option']->value['binary']) {?> binary<?php }?>"
...
">
                            ...
                            <label class="custom-control-label" for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value['id'], ENT_QUOTES, 'UTF-8');?>
">
...
-additional-information"
                            class="mt-2 js-additional-information definition-list additional-information<?php if ($_smarty_tpl->tpl_vars['option']->value['id'] != $_smarty_tpl->tpl_vars['selected_payment_option']->value) {?> ps-hidden <?php }?>"
                    >
...
?>
                <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label js-terms"
                           for="conditions_to_approve[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['condition_name']->value, ENT_QUOTES, 'UTF-8');?>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"
                            aria-label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Close','d'=>'Shop.Theme.Global'),$_smarty_tpl ) );?>
">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"
                            data-dismiss="modal"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Close','d'=>'Shop.Theme.Global'),$_smarty_tpl ) );?>
</button>
                </div>
            </div>
        </div>
