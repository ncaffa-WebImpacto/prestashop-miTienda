...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'file_dependency' => 
  array (
    '199fc483f0886108c51828027f96f5242b556794' => 
    array (
      0 => 'C:\\xampp\\htdocs\\mitienda\\themes\\PRS028\\modules\\tdproductwishlist\\views\\templates\\hook\\tdproductwishlist_button.tpl',
      1 => 1589401702,
      2 => 'file',
    ),
  ),
...
<div class="wishlist">
	<?php if (isset($_smarty_tpl->tpl_vars['wishlists']->value) && count($_smarty_tpl->tpl_vars['wishlists']->value) > 1) {?>
		<div class="dropdown td-wishlist-button-dropdown">
			<button class="td-wishlist-button tip_inside dropdown-toggle show-list btn-primary btn-product btn<?php if ($_smarty_tpl->tpl_vars['added_wishlist']->value) {?> added<?php }?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-id-wishlist="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_wishlist']->value, ENT_QUOTES, 'UTF-8');?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<?php } else { ?>
		<a class="td-wishlist-button btn btn-primary tip_inside<?php if ($_smarty_tpl->tpl_vars['added_wishlist']->value) {?> added<?php }?>" href="javascript:void(0)" data-id-wishlist="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_wishlist']->value, ENT_QUOTES, 'UTF-8');?>
" data-id-product="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['wishlist_id_product']->value, ENT_QUOTES, 'UTF-8');?>
" data-id-product-attribute="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['wishlist_id_product_attribute']->value, ENT_QUOTES, 'UTF-8');?>
">
			<svg width="18px" height="18px" fill="currentcolor">
