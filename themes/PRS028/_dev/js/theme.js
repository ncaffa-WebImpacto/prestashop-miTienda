...
import './lib/owlcarousel.min';
import './lib/magnific-popup.min';
import './lib/theia-sticky-sidebar.min';
...
$(document).ready(() => {
  ...
  let owlCarousel = new OwlCarousel();
  let dropDown = new DropDown($('.js-dropdown'));
