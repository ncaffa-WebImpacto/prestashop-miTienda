...
<div class="wishlist">
	...
	{else}
		<a class="td-wishlist-button btn btn-primary tip_inside{if $added_wishlist} added{/if}" href="javascript:void(0)" data-id-wishlist="{$id_wishlist}" data-id-product="{$wishlist_id_product}" data-id-product-attribute="{$wishlist_id_product_attribute}">
			<svg width="18px" height="18px" fill="currentcolor">
				<use xlink:href="#tdswishlist">
				</use>
			</svg>
