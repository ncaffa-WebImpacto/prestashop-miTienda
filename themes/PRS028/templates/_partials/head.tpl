...
{block name='hook_fonts'}
  ...
  {if $themeOpt.typo_bfont_t == 'google'}
    <link href="{$themeOpt.typo_bfont_g_url}" rel="stylesheet">
  {/if}
  {if $themeOpt.typo_hfont_t == 'google'}
    <link href="{$themeOpt.typo_hfont_g_url}" rel="stylesheet">
  {/if}
  {if $themeOpt.typo_tfont_t == 'google'}
    <link href="{$themeOpt.typo_tfont_g_url}" rel="stylesheet">
  {/if}
{/block}
