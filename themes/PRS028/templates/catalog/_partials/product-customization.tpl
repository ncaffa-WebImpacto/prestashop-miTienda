        ...
        {block name='product_customization_form'}
            <form class="needs-validation" method="post" action="{$product.url}" enctype="multipart/form-data"
                ...
                {foreach from=$customizations.fields item="field"}
                    ...
                    <label for="field-{$field.id_customization_field}" class="mb-2"> {$field.label}{if !$field.required}<small class="text-muted"> ({l s='Optional' d='Shop.Forms.Labels'})</small>{/if}</label>
                    {if $field.type == 'text'}
                        ...
                        <small class="form-text text-muted pull-right">{l s='250 char. max' d='Shop.Forms.Help'}</small>
                        {if $field.text !== ''}
                    ...
                    {elseif $field.type == 'image'}
                        ...
                        <small class="form-text text-muted pull-right">{l s='.png .jpg .gif' d='Shop.Forms.Help'}</small>
