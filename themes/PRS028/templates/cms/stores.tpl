  ...
  <section id="content" class="page-content page-stores">
    {foreach $stores as $store}
      <article id="store-{$store.id}" class="store-item card mb-3">
        <div class="store-item-container card-body clearfix">
          <div class="row">
            <div class="col-md-3 col-lg-3 store-picture visible--desktop">
              <img src="{$store.image.bySize.stores_default.url}" alt="{$store.image.legend}" title="{$store.image.legend}" class="img-fluid">
            </div>
            <div class="col-md-5 col-sm-7 col-12 col-lg-5 store-description">
            ...
            <div class="col-md-4 col-sm-5 col-12 col-lg-4 border-left">
          ...
          <footer id="about-{$store.id}" class="collapse">
            <div class="store-item-footer divide-top">
              {if $store.note}
                <div class="card-block rte-content">
