...
$(document).ready(function () {
    ...
    var p_auto_settings = {
        ...
        source: function(term, response){
            $.getJSON(bitsearch_url, { q: term, ajax: true, action: 'SearchProducts' }, function(data){ response(data); });
        },
...
//update all  menu positions after drag and drop
    ...
    $('.tdcolor').colorPicker({
        ...
        cssAddon: // could also be in a css file instead
            '.cp-color-picker{box-sizing:border-box; width:226px; z-index: 1051;}' +
