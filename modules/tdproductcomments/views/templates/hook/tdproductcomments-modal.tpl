        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title">
                    {l s='Write a review' mod='tdproductcomments'}
                </h2>
            </div>
                        ...
                        <form id="id_new_comment_form" action="#">
                            ...
                            <div class="form-group">
                                <label class="form-control-label" for="comment_title">
                                    {l s='Title:' mod='tdproductcomments'} <sup class="required">*</sup>
                                </label>
                                <input class="form-control" id="comment_title" name="title" type="text" value=""/>
                            </div>
                            <div class="form-group">
                                <label class="form-control-label" for="content">
                                    {l s='Comment:' mod='tdproductcomments'} <sup class="required">*</sup>
                                </label>
                            ...
                            {if $allow_guests == true && !$logged}
                                <div class="form-group">
                                    <label class="form-control-label" for="customer_name">
                                        {l s='Your name:' mod='tdproductcomments'} <sup class="required">*</sup>
                                    </label>
                            ...
                            <div class="form-group">
                                <label class="form-control-label">
                                    <sup class="required">*</sup> {l s='Required fields' mod='tdproductcomments'}
                                </label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{l s='Close' mod='tdproductcomments'}</button>
                <button id="submitNewMessage" name="submitMessage" type="submit" class="btn btn-primary">
                    <span>{l s='Submit' mod='tdproductcomments'}</span>
                </button>
            </div>
        </div>
    </div>
