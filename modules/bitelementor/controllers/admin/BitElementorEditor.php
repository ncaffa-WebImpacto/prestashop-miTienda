...
use BitElementor\Responsive;
use BitElementor\Schemes_Manager;
...
class BitElementorEditorController extends ModuleAdminController
{
    ...
    public function setMedia($isNewTheme = false)
    {
        ...
        $this->addCSS(array(
            ...
            _MODULE_DIR_.'bitelementor/views/lib/font-awesome/css/font-awesome.min.css',
            _MODULE_DIR_.'bitelementor/views/lib/icofont/icofont.min.css',
            _MODULE_DIR_.'bitelementor/views/lib/select2/css/select2.min.css',
            _MODULE_DIR_.'bitelementor/views/lib/eicons/css/elementor-icons.css',
            _MODULE_DIR_.'bitelementor/views/lib/color-picker/color-picker.min.css',
            _MODULE_DIR_.'bitelementor/views/css/admin/editor.css'
        ));

        $this->addJS(array(
            _MODULE_DIR_.'bitelementor/views/lib/jquery/ui/core.min.js?ver=1.11.4',
            _MODULE_DIR_.'bitelementor/views/lib/jquery/ui/widget.min.js?ver=1.11.4',
            _MODULE_DIR_.'bitelementor/views/lib/jquery/ui/mouse.min.js?ver=1.11.4',
            _MODULE_DIR_.'bitelementor/views/lib/jquery/ui/sortable.min.js?ver=1.11.4',
            _MODULE_DIR_.'bitelementor/views/lib/jquery/ui/resizable.min.js?ver=1.11.4',
            _MODULE_DIR_.'bitelementor/views/lib/jquery/ui/position.min.js?ver=1.11.4"',
            _MODULE_DIR_.'bitelementor/views/lib/jquery/ui/draggable.min.js?ver=1.11.4',
            _MODULE_DIR_.'bitelementor/views/lib/jquery/ui/slider.min.js?ver=1.11.4',
            _MODULE_DIR_.'bitelementor/views/lib/jquery/jquery.ui.touch-punch.js?ver=0.2.2',
            _MODULE_DIR_.'bitelementor/views/lib/color-picker/iris.min.js?ver=1.0.7',
            _MODULE_DIR_.'bitelementor/views/lib/color-picker/color-picker.min.js?ver=4.6.1',
            _MODULE_DIR_.'bitelementor/views/lib/color-picker/wp-color-picker-alpha.js?ver=1.1',
            _MODULE_DIR_.'bitelementor/views/lib/waypoints/waypoints-for-editor.js?ver=2.0.2',
            _MODULE_DIR_.'bitelementor/views/lib/imagesloaded/imagesloaded.min.js?ver=4.1.0',
            _MODULE_DIR_.'bitelementor/views/lib/lazyload/lazyload.transpiled.min.js',
            _MODULE_DIR_.'bitelementor/views/lib/jquery-numerator/jquery-numerator.min.js?ver=0.2.0',
            _MODULE_DIR_.'bitelementor/views/lib/slick/slick.min.js?ver=1.6.0',
            _MODULE_DIR_.'bitelementor/views/lib/owl-carousel/owl-carousel.min.js?ver=1.6.0',
            _MODULE_DIR_.'bitelementor/views/lib/underscore/underscore-min.js',
            _MODULE_DIR_.'bitelementor/views/lib/instagram-lite-master/instagramLite.min.js',
            _MODULE_DIR_.'bitelementor/views/lib/backbone/backbone-min.js',
            _MODULE_DIR_.'bitelementor/views/lib/backbone/backbone.marionette.js?ver=2.4.5',
            _MODULE_DIR_.'bitelementor/views/lib/backbone/backbone.radio.min.js?ver=1.0.4',
            _MODULE_DIR_.'bitelementor/views/lib/perfect-scrollbar/perfect-scrollbar.jquery.min.js?ver=0.6.12',
            _MODULE_DIR_.'bitelementor/views/lib/jquery-easing/jquery-easing.min.js?ver=1.3.2',
            _MODULE_DIR_.'bitelementor/views/lib/nprogress/nprogress.js?ver=0.2.0',
            _MODULE_DIR_.'bitelementor/views/lib/tipsy/tipsy.min.js?ver=1.0.0',
            _MODULE_DIR_.'bitelementor/views/lib/ps-helper/ps-helper.js',
            _MODULE_DIR_.'bitelementor/views/lib/dialog/dialog.js?ver=3.0.0',
            _MODULE_DIR_.'bitelementor/views/lib/select2/js/select2.min.js?ver=4.0.2',
            _MODULE_DIR_.'bitelementor/views/js/front/frontend.js?ver=0.9.3',
            _MODULE_DIR_.'bitelementor/views/js/admin/editor.js?ver=0.9.3',
        ));
    ...
    public function display()
    {
        ...
        switch ($pageType) {
            case 'landing':
                $editedPage = new BitElementorLanding($pageId, $idLang);
                $editedPageLink = $this->context->link->getAdminLink('AdminBitElementor') . '&id_page='. $pageId .'&updatebit_elementor_landing';
                $elementorData  = Tools::jsonDecode($editedPage->data, true);
                break;
            case 'cms':
        ...
        $previewLink = $this->context->link->getModuleLink('bitelementor', 'Preview', array(
            'bit_fronteditor_token' => $this->module->getFrontEditorToken(),
        ...
        Media::addJsDef(
            array('ElementorConfig' => [
                'ajaxurl' =>  $this->context->link->getAdminLink('BitElementorEditor').'&ajax=1',
        ...
        $this->smartyOutputContent(_PS_MODULE_DIR_ .'/bitelementor/views/templates/admin/adminbitelementor.tpl');
    }
    ...
    public function ajaxProcessSaveEditor()
    {
        ...
        switch ($pageType) {
            case 'landing':
                $landing = new BitElementorLanding($pageId, $idLang);
                $landing->data = $data;
                $landing->update();
    ...
    public function ajaxProcessGetLanguageContent()
    {
        ...
        switch ($pageType) {
            case 'landing':
                $source = new BitElementorLanding($pageId, $idLang);
                $data = Tools::jsonDecode($source->data, true);
                break;
            case 'cms':
    ...
    public function ajaxProcessGetTemplates()
    {
        ...
        $templatesSource = BitElementorTemplate::getTemplates();
        $templates = array();
    ...
    public function ajaxProcessSaveTemplate()
    {
        ...
        $data = $this->getJsonValue('data');
        $template = new BitElementorTemplate();
    ...
    public function ajaxProcessGetTemplateContent()
    {
        ...
        $return = array(
            'success' => true,
            'data' => Tools::jsonDecode($template->data, true)
        );
    ...
    public function ajaxProcessExportTemplate()
    {
        ...
        header('Content-disposition: attachment; filename=bitelementor_template_id_'.$template->id.'.json');
        header('Content-type: application/json');
        print_r(Tools::jsonEncode($content));
        die;
    }
    ...
    public function ajaxProcessImportTemplate()
    {
        ...
        if (isset($_FILES['file']) && isset($_FILES['file']['tmp_name'])) {
            $templateSource = Tools::jsonDecode(Tools::file_get_contents($_FILES['file']['tmp_name']));
            $template = new BitElementorTemplate();
    ...
    {
        return $previewLink = $this->context->link->getModuleLink('bitelementor', 'Preview', array(
            'bit_fronteditor_token' => $this->module->getFrontEditorToken(),
            'admin_webpath' => $this->context->controller->admin_webpath,
