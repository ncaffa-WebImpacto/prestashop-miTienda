...
<script type="text/template" id="tmpl-elementor-panel-element-languageselector">
		<div><?php \BitElementorWpHelper::_e( 'Editing:', 'elementor' ); ?>
			<select>
			...
			<div  title="<?php \BitElementorWpHelper::_e( 'Import from  other language', 'elementor' ); ?>" id="elementor-panel-elements-language-import">
				...
				<div id="elementor-panel-elements-language-import-list">
					<?php \BitElementorWpHelper::_e( 'Import content from  other language', 'elementor' ); ?>
					<ul>
					<# _.each( elementor.config.languages, function( language ) { #>
...
<script type="text/template" id="tmpl-elementor-panel-element-search">
	<input id="elementor-panel-elements-search-input" placeholder="<?php  \BitElementorWpHelper::_e( 'Search Widget...', 'elementor' ); ?>" />
