...
<script type="text/template" id="tmpl-elementor-panel-header">
	<div id="elementor-panel-header-menu-button" class="elementor-header-button">
		<i class="elementor-icon eicon-menu tooltip-target" data-tooltip="<?php \BitElementorWpHelper::esc_attr_e( 'Menu', 'elementor' ); ?>"></i>
	</div>
	<div id="elementor-panel-header-title"></div>
	<div id="elementor-panel-header-add-button" class="elementor-header-button">
		<i class="elementor-icon eicon-apps tooltip-target" data-tooltip="<?php \BitElementorWpHelper::esc_attr_e( 'Widgets Panel', 'elementor' ); ?>"></i>
	</div>
</script>

<script type="text/template" id="tmpl-elementor-panel-footer-content">
	<div id="elementor-panel-footer-exit" class="elementor-panel-footer-tool" title="<?php \BitElementorWpHelper::_e( 'Exit', 'elementor' ); ?>">
		...
		<div class="elementor-panel-footer-sub-menu-wrapper">
			<div class="elementor-panel-footer-sub-menu">
				<a id="elementor-panel-footer-view-edit-page" class="elementor-panel-footer-sub-menu-item" href="./">
					...
					<span class="elementor-title"><?php \BitElementorWpHelper::_e( 'Go to Backoffice', 'elementor' ); ?></span>
				</a>
			</div>
		</div>
	</div>
	<div id="elementor-panel-footer-responsive" class="elementor-panel-footer-tool" title="<?php \BitElementorWpHelper::esc_attr_e( 'Responsive Mode', 'elementor' ); ?>">
		...
		<div class="elementor-panel-footer-sub-menu-wrapper">
			<div class="elementor-panel-footer-sub-menu">
				<div class="elementor-panel-footer-sub-menu-item" data-device-mode="desktop">
					...
					<span class="elementor-title"><?php \BitElementorWpHelper::_e( 'Desktop', 'elementor' ); ?></span>
					<span class="elementor-description"><?php \BitElementorWpHelper::_e( 'Default Preview', 'elementor' ); ?></span>
				</div>
				<div class="elementor-panel-footer-sub-menu-item" data-device-mode="tablet">
					<i class="elementor-icon eicon-device-tablet"></i>
					<span class="elementor-title"><?php \BitElementorWpHelper::_e( 'Tablet', 'elementor' ); ?></span>
					<span class="elementor-description"><?php \BitElementorWpHelper::_e( 'Preview for 768px', 'elementor' ); ?></span>
				</div>
				<div class="elementor-panel-footer-sub-menu-item" data-device-mode="mobile">
					<i class="elementor-icon eicon-device-mobile"></i>
					<span class="elementor-title"><?php \BitElementorWpHelper::_e( 'Mobile', 'elementor' ); ?></span>
					<span class="elementor-description"><?php \BitElementorWpHelper::_e( 'Preview for 360px', 'elementor' ); ?></span>
				</div>
			</div>
		</div>
	</div>
	<div id="elementor-panel-footer-help" class="elementor-panel-footer-tool" title="<?php \BitElementorWpHelper::esc_attr_e( 'Help', 'elementor' ); ?>">
		<span class="elementor-screen-only"><?php \BitElementorWpHelper::_e( 'Help', 'elementor' ); ?></span>
		<i class="fa fa-question-circle"></i>
		<div class="elementor-panel-footer-sub-menu-wrapper">
			<div class="elementor-panel-footer-sub-menu">
				<div id="elementor-panel-footer-help-title"><?php \BitElementorWpHelper::_e( 'Need help?', 'elementor' ); ?></div>
				<div id="elementor-panel-footer-watch-tutorial" class="elementor-panel-footer-sub-menu-item">
					...
					<span class="elementor-title"><?php \BitElementorWpHelper::_e( 'Take a tour', 'elementor' ); ?></span>
				</div>
				<!-- <div class="elementor-panel-footer-sub-menu-item">
					<i class="elementor-icon fa fa-external-link"></i>
					<a class="elementor-title" href="<?php echo ELEMENTOR_PATH; ?>documentation.pdf" target="_blank"><?php \BitElementorWpHelper::_e( 'Go to the Documentation', 'elementor' ); ?></a>
				</div> -->
			</div>
		</div>
	</div>
	<div id="elementor-panel-footer-templates" class="elementor-panel-footer-tool" title="<?php \BitElementorWpHelper::esc_attr_e( 'Templates', 'elementor' ); ?>">
		<span class="elementor-screen-only"><?php \BitElementorWpHelper::_e( 'Templates', 'elementor' ); ?></span>
		...
		<div class="elementor-panel-footer-sub-menu-wrapper">
			<div class="elementor-panel-footer-sub-menu">
				<div id="elementor-panel-footer-templates-modal" class="elementor-panel-footer-sub-menu-item">
					...
					<span class="elementor-title"><?php \BitElementorWpHelper::_e( 'Templates Library', 'elementor' ); ?></span>
				</div>
				<div id="elementor-panel-footer-save-template" class="elementor-panel-footer-sub-menu-item">
					...
					<span class="elementor-title"><?php \BitElementorWpHelper::_e( 'Save Template', 'elementor' ); ?></span>
				</div>
			</div>
		</div>
	</div>
	<div id="elementor-panel-footer-save" class="elementor-panel-footer-tool" title="<?php \BitElementorWpHelper::esc_attr_e( 'Save', 'elementor' ); ?>">
...
<script type="text/template" id="tmpl-elementor-mode-switcher-content">
	...
	<label for="elementor-mode-switcher-preview-input" id="elementor-mode-switcher-preview" title="<?php \BitElementorWpHelper::esc_attr_e( 'Preview', 'elementor' ); ?>">
		<span class="elementor-screen-only"><?php \BitElementorWpHelper::_e( 'Preview', 'elementor' ); ?></span>
		<i class="fa"></i>
	</label>
</script>
	...
	<div class="elementor-panel-scheme-buttons">
		<div class="elementor-panel-scheme-button-wrapper elementor-panel-scheme-reset">
			<button class="elementor-button">
				...
				<?php \BitElementorWpHelper::_e( 'Reset', 'elementor' ); ?>
			</button>
		</div>
		<div class="elementor-panel-scheme-button-wrapper elementor-panel-scheme-discard">
			<button class="elementor-button">
				<i class="fa fa-times"></i>
				<?php \BitElementorWpHelper::_e( 'Discard', 'elementor' ); ?>
			</button>
		</div>
		<div class="elementor-panel-scheme-button-wrapper elementor-panel-scheme-save">
			<button class="elementor-button elementor-button-success" disabled><?php \BitElementorWpHelper::_e( 'Apply', 'elementor' ); ?></button>
		</div>
	</div>
...
<script type="text/template" id="tmpl-elementor-panel-schemes-color">
	...
	<div class="elementor-panel-scheme-content elementor-panel-box">
		<div class="elementor-panel-heading">
			<div class="elementor-panel-heading-title"><?php \BitElementorWpHelper::_e( 'Color Palette', 'elementor' ); ?></div>
		</div>
	...
	<div class="elementor-panel-scheme-colors-more-palettes elementor-panel-box">
		<div class="elementor-panel-heading">
			<div class="elementor-panel-heading-title"><?php \BitElementorWpHelper::_e( 'More Palettes', 'elementor' ); ?></div>
		</div>
				...
				<div class="elementor-panel-scheme-color-system-scheme" data-scheme-name="<?php echo $scheme_name; ?>">
					<div class="elementor-panel-scheme-color-system-items">
						...
						foreach ( $colors_to_print as $color_value ) : ?>
							<div class="elementor-panel-scheme-color-system-item" style="background-color: <?php echo \BitElementorWpHelper::esc_attr( $color_value ); ?>;"></div>
						<?php endforeach; ?>
					</div>
			...
			<div class="elementor-panel-scheme-typography-item">
				...
				<div class="elementor-panel-scheme-typography-item-value">
					...
					<?php elseif ( 'font' === $option['type'] ) : ?>
						<select name="<?php echo $option_name; ?>" class="elementor-panel-scheme-typography-item-field">
							<option value=""><?php \BitElementorWpHelper::_e( 'Default', 'elementor' ); ?></option>

							<optgroup label="<?php \BitElementorWpHelper::_e( 'System', 'elementor' ); ?>">
								<?php foreach ( Fonts::get_fonts_by_groups( [ Fonts::SYSTEM ] ) as $font_title => $font_type ) : ?>
									<option value="<?php echo \BitElementorWpHelper::esc_attr( $font_title ); ?>"><?php echo $font_title; ?></option>
								<?php endforeach; ?>
							</optgroup>

							<optgroup label="<?php \BitElementorWpHelper::_e( 'Google', 'elementor' ); ?>">
