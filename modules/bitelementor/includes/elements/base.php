...
abstract class Element_Base {
    ...
    private static function _get_available_tabs_controls() {
        if ( ! self::$_available_tabs_controls ) {
            self::$_available_tabs_controls = [
                self::TAB_CONTENT => \BitElementorWpHelper::__( 'Content', 'elementor' ),
                self::TAB_STYLE => \BitElementorWpHelper::__( 'Style', 'elementor' ),
                self::TAB_ADVANCED => \BitElementorWpHelper::__( 'Advanced', 'elementor' ),
                self::TAB_RESPONSIVE => \BitElementorWpHelper::__( 'Responsive', 'elementor' ),
                self::TAB_LAYOUT => \BitElementorWpHelper::__( 'Layout', 'elementor' ),
            ];
            ...
            <div class="elementor-editor-element-settings elementor-editor-<?php echo \BitElementorWpHelper::esc_attr( $this->get_type() ); ?>-settings elementor-editor-<?php echo \BitElementorWpHelper::esc_attr( $this->get_id() ); ?>-settings">
                <ul class="elementor-editor-element-settings-list">
                    <li class="elementor-editor-element-setting elementor-editor-element-add">
                        <a href="#" title="<?php \BitElementorWpHelper::_e( 'Add Widget', 'elementor' ); ?>">
                    ...
                    <li class="elementor-editor-element-setting elementor-editor-element-edit">
                        <a href="#" title="<?php \BitElementorWpHelper::_e( 'Edit Widget', 'elementor' ); ?>">
                    ...
                    */ ?>
                    <li class="elementor-editor-element-setting elementor-editor-element-duplicate">
                        <a href="#" title="<?php \BitElementorWpHelper::_e( 'Duplicate Widget', 'elementor' ); ?>">
                            <span class="elementor-screen-only"><?php \BitElementorWpHelper::_e( 'Duplicate', 'elementor' ); ?></span>
                            <i class="fa fa-files-o"></i>
                        </a>
                    </li>
                    <li class="elementor-editor-element-setting elementor-editor-element-remove">
                        <a href="#" title="<?php \BitElementorWpHelper::_e( 'Remove Widget', 'elementor' ); ?>">
    ...
    public function add_control( $id, $args ) {
        ...
        if ( isset( $this->_controls[ $id ] ) ) {
            \BitElementorWpHelper::_doing_it_wrong( __CLASS__ . '::' . __FUNCTION__, 'Cannot redeclare control with same name. - ' . $id, '1.0.0' );
        ...
        if ( ! in_array( $args['type'], [ Controls_Manager::SECTION, Controls_Manager::WP_WIDGET ] ) ) {
            if ( null !== $this->_current_section ) {
                ...
                \BitElementorWpHelper::_doing_it_wrong( __CLASS__ . '::' . __FUNCTION__ . ': Cannot add a control outside a section (use `start_controls_section`).' );
            }
        }
    ...
    public function get_render_attribute_string( $element ) {
        ...
        foreach ( $render_attributes as $attribute_key => $attribute_values ) {
            $attributes[] = sprintf( '%s="%s"', $attribute_key, \BitElementorWpHelper::esc_attr( implode( ' ', $attribute_values ) ) );
        }
