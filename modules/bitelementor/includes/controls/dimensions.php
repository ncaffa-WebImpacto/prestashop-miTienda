				...
				<ul class="elementor-control-dimensions">
					<?php foreach ( $dimensions as $dimension_key => $dimension_title ) : ?>
						<li class="elementor-control-dimension">
							<input type="number" data-setting="<?php echo \BitElementorWpHelper::esc_attr( $dimension_key ); ?>"
							       placeholder="<#
					...
					<?php endforeach; ?>
					<li>
						<button class="elementor-link-dimensions tooltip-target" data-tooltip="<?php \BitElementorWpHelper::_e( 'Link values together', 'elementor' ); ?>">
