...
class Control_Select_Sort extends Control_Base {
	...
	public function content_template() {
		...
		<button class="elementor-button elementor-value-add"><i class="fa fa-angle-down"></i><?php \BitElementorWpHelper::_e( 'Select', 'elementor' ); ?></button>

		<div class="elementor-control-field"><label class="elementor-control-title"><?php \BitElementorWpHelper::_e( 'Selected', 'elementor' ); ?></label></div>
		<div class="elementor-control-field">
