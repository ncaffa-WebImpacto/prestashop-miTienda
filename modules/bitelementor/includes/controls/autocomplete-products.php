		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				...
				<div class="elementor-control-content elementor-selected-products-wrapper">
						<div class="elementor-control-field">
							<label class="elementor-control-title"> <# if ( data.single ) { #> <?php \BitElementorWpHelper::_e( 'Selected product', 'elementor' ); ?><# } else { #> <?php \BitElementorWpHelper::_e( 'Selected products', 'elementor' ); ?><# } #></label>
