...
abstract class Control_Base {
	...
	final public function print_template() {
		?>
		<script type="text/html" id="tmpl-elementor-control-<?php echo \BitElementorWpHelper::esc_attr( $this->get_type() ); ?>-content">
	...
	public function __construct() {
		$this->_settings = \BitElementorWpHelper::wp_parse_args( $this->get_default_settings(), $this->_base_settings );
	}
}
