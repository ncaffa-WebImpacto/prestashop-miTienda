...
class Control_Modules extends Control_Base {
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select data-setting="{{ data.name }}">
					<option value="0"><?php \BitElementorWpHelper::_e( 'Select module', 'elementor' ); ?></option>
		...
		<div class="elementor-control-field">
			<label class="elementor-control-title"><?php \BitElementorWpHelper::_e( 'Hook', 'elementor' ); ?></label>
			<div class="elementor-control-input-wrapper">
