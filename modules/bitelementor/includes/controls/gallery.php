		...
		<div class="elementor-control-field">
			<div class="elementor-control-input-wrapper">
				...
				<div class="elementor-control-media">
					<div class="elementor-control-gallery-status">
						<span class="elementor-control-gallery-status-title">
							<# if ( data.controlValue.length ) {
								...
								<?php \BitElementorWpHelper::_e( 'No Images Selected', 'elementor' ); ?>
							<# } #>
						</span>
						<span class="elementor-control-gallery-clear">(<?php \BitElementorWpHelper::_e( 'Clear', 'elementor' ); ?>)</span>
					</div>
					...
					<button class="elementor-button elementor-control-gallery-add"><?php \BitElementorWpHelper::_e( '+ Add Images', 'elementor' ); ?></button>
				</div>
			</div>
		</div>
		<?php
