...
class Widget_Audio extends Widget_Base {
	...
	public function get_title() {
		return \BitElementorWpHelper::__( 'SoundCloud', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->add_control(
			'section_audio',
			[
				'label' => \BitElementorWpHelper::__( 'SoundCloud', 'elementor' ),
		...
		$this->add_control(
			'visual',
			[
				'label' => \BitElementorWpHelper::__( 'Visual Player', 'elementor' ),
		...
		$this->add_control(
			'section_sc_options',
			[
				'label' => \BitElementorWpHelper::__( 'Additional Options', 'elementor' ),
		...
		$this->add_control(
			'sc_buying',
			[
				'label' => \BitElementorWpHelper::__( 'Buy Button', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'show',
				'options' => [
		...
		$this->add_control(
			'sc_liking',
			[
				'label' => \BitElementorWpHelper::__( 'Like Button', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'show',
				'options' => [
					'show' => \BitElementorWpHelper::__( 'Show', 'elementor' ),
		...
		$this->add_control(
			'sc_download',
			[
				'label' => \BitElementorWpHelper::__( 'Download Button', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'show',
				'options' => [
					'show' => \BitElementorWpHelper::__( 'Show', 'elementor' ),
		...
		$this->add_control(
			'sc_sharing',
			[
				'label' => \BitElementorWpHelper::__( 'Share Button', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'show',
				'options' => [
					'show' => \BitElementorWpHelper::__( 'Show', 'elementor' ),
		...
		$this->add_control(
			'sc_show_comments',
			[
				'label' => \BitElementorWpHelper::__( 'Comments', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'show',
				'options' => [
					'show' => \BitElementorWpHelper::__( 'Show', 'elementor' ),
		...
		$this->add_control(
			'sc_show_playcount',
			[
				'label' => \BitElementorWpHelper::__( 'Play Counts', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'show',
				'options' => [
					'show' => \BitElementorWpHelper::__( 'Show', 'elementor' ),
		...
		$this->add_control(
			'sc_show_user',
			[
				'label' => \BitElementorWpHelper::__( 'Username', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'show',
				'options' => [
					'show' => \BitElementorWpHelper::__( 'Show', 'elementor' ),
	...
	public function filter_oembed_result( $html ) {
		...
		$url = \BitElementorWpHelper::esc_url( $matches[1] );
