...
class Widget_Icon_List extends Widget_Base {
	...
	public function get_title() {
		return \BitElementorWpHelper::__( 'Icon List', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->add_control(
			'section_icon',
			[
				'label' => \BitElementorWpHelper::__( 'Icon List', 'elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
                    ...
                    'inline'   => \BitElementorWpHelper::__( 'Inline', 'elementor' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text' => \BitElementorWpHelper::__( 'List Item #1', 'elementor' ),
						'icon' => 'fa fa-check',
					],
					[
						'text' => \BitElementorWpHelper::__( 'List Item #2', 'elementor' ),
						'icon' => 'fa fa-times',
					],
					[
						'text' => \BitElementorWpHelper::__( 'List Item #3', 'elementor' ),
				...
				'fields' => [
					[
						...
						'label_block' => true,
						'placeholder' => \BitElementorWpHelper::__( 'List Item', 'elementor' ),
						'default' => \BitElementorWpHelper::__( 'List Item', 'elementor' ),
					],
					[
						'name' => 'icon',
		...
		$this->add_control(
			'text_indent',
			[
				'label' => \BitElementorWpHelper::__( 'Text Indent', 'elementor' ),
				'type' => Controls_Manager::SLIDER,
				'tab' => self::TAB_STYLE,
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-icon-list-text' => \BitElementorWpHelper::is_rtl() ? 'padding-right: {{SIZE}}{{UNIT}};' : 'padding-left: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render( $instance = [] ) {
		...
		if ( 'inline' === $instance['icon_layout'] ) {
				...
				<li class="elementor-icon-list-item">
					...
					if ( $item['icon'] ) : ?>
						<span class="elementor-icon-list-icon">
							<i class="<?php echo \BitElementorWpHelper::esc_attr( $item['icon'] ); ?>"></i>
						</span>
					<?php endif; ?>
