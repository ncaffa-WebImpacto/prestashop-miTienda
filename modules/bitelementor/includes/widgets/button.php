...
class Widget_Button extends Widget_Base {
	...
	public function get_title() {
		return \BitElementorWpHelper::__( 'Button', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'secondary' => \BitElementorWpHelper::__( 'Default', 'elementor' ),
					'primary' => \BitElementorWpHelper::__( 'Action', 'elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'section' => 'section_button',
				'options' => [
					'traditional' => \BitElementorWpHelper::__( 'Default', 'elementor' ),
					'block' => \BitElementorWpHelper::__( 'Block', 'elementor' ),
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '1px',
				'section' => 'section_style',
				'selector' => '{{WRAPPER}} .elementor-button.btn-secondary',
			]
		);
				...
				<span <?php echo $this->get_render_attribute_string( 'content-wrapper' ); ?>>
					<?php if ( ! empty( $instance['icon'] ) ) : ?>
						<span <?php echo $this->get_render_attribute_string( 'icon-align' ); ?>>
							<i class="<?php echo \BitElementorWpHelper::esc_attr( $instance['icon'] ); ?>"></i>
						</span>
					<?php endif; ?>
