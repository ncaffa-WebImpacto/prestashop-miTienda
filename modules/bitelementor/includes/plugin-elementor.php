...
class PluginElementor {
    ...
    public function __wakeup() {
        ...
        \BitElementorWpHelper::_doing_it_wrong( __FUNCTION__, \BitElementorWpHelper::__( 'Cheatin&#8217; huh?', 'elementor' ), '1.0.0' );
    }
    ...
    public function get_current_introduction() {
        return [
            ...
            'title' => '<div id="elementor-introduction-title">' .
                \BitElementorWpHelper::__( 'Two Minute Tour Of Elementor', 'elementor' ) .
                '</div><div id="elementor-introduction-subtitle">' .
                \BitElementorWpHelper::__( 'Watch this quick tour that gives you a basic understanding of how to use Elementor.', 'elementor' ) .
                '</div>',
