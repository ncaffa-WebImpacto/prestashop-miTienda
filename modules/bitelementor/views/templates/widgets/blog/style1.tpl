	...
	<div class="blog_post">
		<div class="blog-image-container">
			...
			<span class="blog_date">
				<span class="date_info">
					<span class="day_date">{$post.date_add|date_format:"%d"}</span> 
					<span class="day_month">{$post.date_add|date_format:"%b"}</span>
				</span>
			</span>
		</div>
		<div class="blog_content">
			...
			<div class="readmore_btn">
				<a class="more" href="{$post.link|escape:'html':'UTF-8'}" title="{$post.title|escape:'html':'UTF-8'}"><i class="fa fa-caret-right mr-2"></i>{l s='Read more' mod='bitelementor'}</a>
			</div>
		</div>
	</div>
</div>