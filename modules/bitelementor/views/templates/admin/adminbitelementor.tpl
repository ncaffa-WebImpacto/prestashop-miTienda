...
<head>
  ...
  <title>{l s='Elementor editor' mod='bitelementor'}</title>
  {* heade section *}
    ...
    <div id="elementor-add-section-inner">
      <div id="elementor-add-new-section">
        <button id="elementor-add-section-button"
                class="elementor-button">{l s='Add New Section' mod='bitelementor'}</button>
        <button id="elementor-add-template-button"
                class="elementor-button">{l s='Add Template' mod='bitelementor'}</button>
        <div id="elementor-add-section-drag-title">{l s='Or drag widget here' mod='bitelementor'}</div>
      </div>
      <div id="elementor-select-preset">
        <div id="elementor-select-preset-close">
          <i class="fa fa-times"></i>
        </div>
        <div id="elementor-select-preset-title">{l s='Select your Structure' mod='bitelementor'}</div>
