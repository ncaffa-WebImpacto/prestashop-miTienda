...
/**
* Class ElementorWidget_ProductsListTabs
*/
class BitElementorWidget_ProductsListTabs
{
    /**
    * @var int
    */
    ...
    */
    ...
    {
        $this->name = BitElementorWpHelper::__('Tabs with products', 'elementor');
    ...
    public function getForm()
    {
        ...
        $productSourceOptions['bb'] = BitElementorWpHelper::__('By brand', 'elementor');
        $productSourceOptions['np'] = BitElementorWpHelper::__('New products', 'elementor');
        $productSourceOptions['pd'] = BitElementorWpHelper::__('Price drops', 'elementor');
        $productSourceOptions['bs'] = BitElementorWpHelper::__('Best sellers', 'elementor');
        ...
        return [
            ...
            'style_preset' => [
                ...
                'options' => [
                    ...
                    '3' => BitElementorWpHelper::__('Style 3', 'elementor'),
                    'left' => BitElementorWpHelper::__('Style Left', 'elementor'),
                ],
            ],
            'tabs' => [
                ...
                'fields' => [
                    ...
                    [
                        'name' =>  'brand_list',
                        'label' => BitElementorWpHelper::__('Select brand', 'elementor'),
                        'type' => 'select',
                        'default' => 0,
                        'label_block' => true,
            ...
            'tab_color' => [
                'label' => BitElementorWpHelper::__('Tab color', 'elementor'),
                'type' => 'color',
                'tab' => 'style',
                'responsive' => true,
                'section' => 'section_style_tabs',
            ...
            'product_bg_color' => [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .product-miniature.style-3 .product-container .products-variants' => 'background: {{VALUE}};',
                ],
            ],
            ...
            'product_bg_color_h' => [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .product-miniature.style-3:hover .product-container .products-variants' => 'background: {{VALUE}};',
                ],
            ],
            'product_text_color_h' => [
                ...
                'section' => 'section_style_product_h',
                'selectors' => [
                    '{{WRAPPER}} .product-miniature .product-container:hover .product-title a' => 'color: {{VALUE}};',
                ],
            ],
            'product_price_color_h' => [
                ...
                'section' => 'section_style_product_h',
                'selectors' => [
                    '{{WRAPPER}} .product-miniature .product-container:hover .product-price-and-shipping .price' => 'color: {{VALUE}};',
                ],
            ],
            'product_stars_color_h' => [
                ...
                'section' => 'section_style_product_h',
                'selectors' => [
                    '{{WRAPPER}} .product-miniature .product-container:hover .star:after' => 'color: {{VALUE}};',
                ],
            ],
            'border_h' => [
            ...
            'box-shadow_h' => [
                ...
                'default' => '1px',
                'section' => 'section_style_product_h',
                'selector' => '{{WRAPPER}} .product-miniature:hover, .product-miniature.style-3:hover .product-container .products-variants ',
            ], 
            ...
            'both_btn_bg_color' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .products .product-miniature.style-1 .product-container .button-container .btn-primary' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .products .product-miniature.style-2 .product-container .button-container .btn-primary' => 'background: {{VALUE}};',
                ],
                'condition' => [
                    'style_preset' => ['1','2'],
                ],
            ...
            'both_btn_color' => [
                ...
                'section' => 'section_style_both',
                'selectors' => [
                    '{{WRAPPER}} .products .product-miniature.style-1 .product-container .button-container .btn-primary' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .products .product-miniature.style-2 .product-container .button-container .btn-primary' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'style_preset' => ['1','2'],
                ],
            ...
            'both_border_radius' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .products .product-miniature.style-1 .product-container .button-container .btn-primary' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .products .product-miniature.style-2 .product-container .button-container .btn-primary' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            ...
            'both_box_shadow' => [
                ...
                'selector' => '{{WRAPPER}} .products .product-miniature.style-2 .product-container .button-container .btn-primary',
            ],
            ...
            'both_btn_bg_color_h' => [
                ...
                'section' => 'section_style_both',
                'selectors' => [
                    '{{WRAPPER}} .products .product-miniature.style-1 .product-container .button-container .btn-primary:hover' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .products .product-miniature.style-2 .product-container .button-container .btn-primary:hover' => 'background: {{VALUE}};',
                ],
                'condition' => [
                    'style_preset' => ['1','2'],
                ],
            ...
            'both_btn_color_h' => [
                ...
                'section' => 'section_style_both',
                'selectors' => [
                    '{{WRAPPER}} .products .product-miniature.style-1 .product-container .button-container .btn-primary:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .products .product-miniature.style-2 .product-container .button-container .btn-primary:hover' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'style_preset' => ['1','2'],
                ],
            ...
            'both_box_shadow_h' => [
                ...
                'selector' => '{{WRAPPER}} .products .product-miniature.style-2 .product-container .button-container .btn-primary:hover',
            ],
            
            'section_style3' => [
                'label' => BitElementorWpHelper::__('Style 3 Button', 'elementor'),
                'type' => 'section',
                'tab' => 'style',
                'condition' => [
                    'style_preset' => ['3'],
            ...
            'btn_box_bg_color' => [
                'label' => BitElementorWpHelper::__('Button Box bg color', 'elementor'),
                'type' => 'color',
                'tab' => 'style',
                'section' => 'section_style3',
                'selectors' => [
                    '{{WRAPPER}} .products .product-miniature.style-3 .product-container .button-container .btn-inner' => 'background: {{VALUE}};',
                ],
                'condition' => [
                    'style_preset' => ['3'],
                ],
            ...
            'btn_box_color' => [
                ...
                'section' => 'section_style3',
                'selectors' => [
                    '{{WRAPPER}} .products .product-miniature.style-3 .product-container .button-container .btn-primary' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'style_preset' => ['3'],
                ],
            ...
            'qv_btn_color' => [
                'label' => BitElementorWpHelper::__('Quickview color', 'elementor'),
                'type' => 'color',
                'tab' => 'style',
                'section' => 'section_style3',
                'selectors' => [
                    '{{WRAPPER}} .products .product-miniature.style-3 .product-container .quick-view-wrapper .btn-primary' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'style_preset' => ['3'],
                ],
            ...
            'btn_box_border_color' => [
                'label' => BitElementorWpHelper::__('Border color', 'elementor'),
                'type' => 'color',
                'tab' => 'style',
                'section' => 'section_style3',
                'selectors' => [
                    '{{WRAPPER}} .products .product-miniature.style-3 .product-container .button-container .wishlist' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
                    'style_preset' => ['3'],
                ],
            ...
            'btn_box_color_h' => [
                ...
                'section' => 'section_style3',
                'selectors' => [
                    '{{WRAPPER}} .products .product-miniature.style-3 .product-container .button-container .btn-primary:hover' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'style_preset' => ['3'],
                ],
            ...
            'qv_btn_color_h' => [
                ...
                'section' => 'section_style3',
                'selectors' => [
                    '{{WRAPPER}} .products .product-miniature.style-3 .product-container .quick-view-wrapper .btn-primary:hover' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'style_preset' => ['3'],
                ],
    ...
    public function parseOptions($optionsSource, $preview = false)
    {
        $tabs = array();
        $parsedOptions = [];
        $uid = Tools::substr(md5(uniqid(mt_rand(), true)), 0, 8);
        ...
        $parsedOptions['owl_options'] = \BitElementorWpHelper::jsonEncode( $owl_options );
        $parsedOptions['style'] =  $optionsSource['style_preset'];
        $parsedOptions['arrows_position'] =  $optionsSource['arrows_position'];
        $parsedOptions['dots_position'] =  $optionsSource['dots_position'];
        $parsedOptions['xld'] =  $optionsSource['xldevice']['size'];
        $parsedOptions['lgd'] =  $optionsSource['lgdevice']['size'];
        $parsedOptions['mdd'] =  $optionsSource['mddevice']['size'];
        $parsedOptions['smd'] =  $optionsSource['smdevice']['size'];
        $parsedOptions['xsd'] =  $optionsSource['xsdevice']['size'];
        $parsedOptions['rows'] =  $optionsSource['items_per_column'];
        $parsedOptions['view'] =  $optionsSource['view'];

        if ($preview) {
            $result = Hook::exec('actionBeforeElementorWidgetRender', array(), null, true);
            if (isset($result['tdthemesettings'])) {
                $parsedOptions['themeOpt'] = $result['tdthemesettings'];
            }
        }
