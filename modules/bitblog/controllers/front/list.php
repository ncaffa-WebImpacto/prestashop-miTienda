...
class BitbloglistModuleFrontController extends ModuleFrontController
{
    public $php_self;
    ...
    {
        $this->php_self = 'module-bitblog-list';
        //$this->php_self = 'list';
        ...
        if ($author) {
            ...
            $r = $helper->getPaginationLink('module-bitblog-list', 'list', array('author' => $author));
        }
        if ($tag) {
            $condition = array(
                'type' => 'tag',
            ...
            $r = $helper->getPaginationLink('module-bitblog-list', 'list', array('tag' => $tag));
        }

        $blogs = BitBlogBlog::getListBlogs(null, $this->context->language->id, $p, $n, 'id_bitblog_blog', 'DESC', $condition, true);
        $count = BitBlogBlog::countBlogs(null, $this->context->language->id, $condition, true);
...
//        $links                 =  array();
        ...
        if (!isset($r)) {
            $r = $helper->getPaginationLink('module-bitblog-list', 'list', array(), false, true);
        }

        //$module_tpl = $this->template_path;
        $module_tpl = 'module:bitblog/views/templates/front/'.$template;
        //$module_tpl_listing = 'module:bitblog/views/templates/front/'.$template.'/_listing_blog.tpl';
        ...
        $this->setTemplate('module:bitblog/views/templates/front/'.$template.'/listing.tpl');
