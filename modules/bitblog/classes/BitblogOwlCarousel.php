...
if (!class_exists('BitblogOwlCarousel')) {
    class BitblogOwlCarousel
    {
        const MODULE_NAME = 'bittempcp';
        ...
        public function getOwlCarouselAdminFormOptions()
        {
            return array(
                ...
                /*
                  array(
                  'type' => 'select',
                  'label' => $this->l('Transition Style', array(), 'Modules.BitBlog.Admin'),
                  'name' => 'owl_transitionStyle',
                  'default' => BitmanagewidgetsOwlCarousel::TRANSITIONSTYLE_FADE,
                  'form_group_class' => 'carousel_type_sub carousel_type-' . self::CAROUSEL_OWL,
                  'options' => array(
                  'query' => BitmanagewidgetsOwlCarousel::getTransitionStyleOptions(),
                  'id' => 'value',
                  'name' => 'name'
                  )
                  ),
