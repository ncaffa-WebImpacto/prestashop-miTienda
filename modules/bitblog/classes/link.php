...
class BitBlogLink extends Link
{
    ...
    public function getBitblogLink($id_object, $controller, $params = array())
    {
     ...
     */
    public function getBitPaginationLink($type, $id_object, $controller, $params, $nb = false, $sort = false, $pagination = false, $array = true)
    {
