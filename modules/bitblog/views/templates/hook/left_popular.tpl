...
{if isset($leading_blogs) AND !empty($leading_blogs)}
    <section id="blogPopularBlog" class="block bit-block-sidebar">
        <h4 class="title_block hidden-md-down">{l s='Popular Articles' mod='bitblog'}</h4>
        <a href="#blogcolumn_block_2" class="h4 hidden-lg-up title_block" data-toggle="collapse">{l s='Popular Articles' mod='bitblog'}</a>
        <div id="blogcolumn_block_2" class="block_content products-block collapse show" data-collapse-hide-mobile>
            <ul class="lists">
