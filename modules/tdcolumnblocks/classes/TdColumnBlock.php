...
class TdColumnBlock extends ObjectModel
{
    public $id;
    public $id_tdcolumnblock;
    public $id_shop;
    public $title;
    public $active = 1;
    public $position;
    ...
    public function __construct($id_tdcolumnblock = null, $id_lang = null)
    {
        parent::__construct($id_tdcolumnblock, $id_lang);
    ...
    public static function initProductOptions($str)
    {
        ...
        if (!isset($options['slider_row']) || (int) $options['slider_row'] < 1) {
            $options['slider_row'] = 1;
        }
    ...
    public static function getList($id_lang = null, $active = true)
    {
        ...
        $query = 'SELECT *
            FROM `'._DB_PREFIX_.'tdcolumnblock` b
            LEFT JOIN `'._DB_PREFIX_.'tdcolumnblock_lang` bl ON b.`id_tdcolumnblock` = bl.`id_tdcolumnblock`
    ...
    public static function updatePosition($id_tdcolumnblock, $position)
    {
        $query = 'UPDATE `'._DB_PREFIX_.'tdcolumnblock`
            SET `position` = '.(int) $position.'
            WHERE `id_tdcolumnblock` = '.(int) $id_tdcolumnblock;
