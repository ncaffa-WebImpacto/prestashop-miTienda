...
$(document).ready(function () {
    ...
    $('#table_generator').on('click', function () {
        tdSizeChartCreateTable();
    });

});


function tdSizeChartCreateTable() {
    ...
    tblDiv.setAttribute("class", "table-responsive");
    ...
    tdSizeChartAssignToTinyMce(tblDiv);
}

function tdSizeChartAssignToTinyMce(content) {
